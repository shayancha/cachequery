...
#define STORE_RAX(Q)			C(0x48, 0xa3,\
	Q&0xff, (Q>>8)&0xff, (Q>>16)&0xff, (Q>>24)&0xff,\
	(Q>>32)&0xff, (Q>>40)&0xff, (Q>>48)&0xff, (Q>>56)&0xff)

#define MOVD_XMM_RAX(S)		C(0x66, 0x48, 0x0f, 0x6e, (S<<3)|0xc0)
#define MOVD_RAX_XMM(S)		C(0x66, 0x48, 0x0f, 0x7e, (S<<3)|0xc0)
//#define PSLLW(D, S)			C(0x66, 0x0f, 0xf1, ((D<<6)|(S<<3))|0xc0)
//#define PSRLW(D, S)			C(0x66, 0x0f, 0xd1, ((D<<6)|(S<<3))|0xc0)
#define PSLLQ16(D)			C(0x66, 0x0f, 0x73, 0xf0 | D, 0x10)//0x04, 0x25, 0x00, 0x00, 0x00, 0x00)
#define PSRLQ16(D)			C(0x66, 0x0f, 0x73, 0xd0 | D, 0x10)//C(0x66, 0x0f, 0xd3, 0x04, 0x25, 0x00, 0x00, 0x00, 0x00)
#define PSLLQ1(D)			C(0x66, 0x0f, 0x73, 0xf0 | D, 0x1)

#define POR(D, S)			C(0x66, 0x0f, 0xeb, ((D<<6)|(S<<3))|0xc0)
#define AND_RAX_WORD()		C(0x48, 0x23, 0x04, 0x25, 0xff, 0xff, 0x00, 0x00)
#define AND_RAX_WORD2()		C(0x48, 0x21, 0x04, 0x25, 0xff, 0xff, 0x00, 0x00)
